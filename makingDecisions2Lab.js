...
if(myFavoriteNumbers.length < 7){
  ...
  console.log('7th value has been assigned to someNum')
}
...
switch (letterGrade) {
  case 'A':
    console.log("You are doing excellent");
    break;
  case 'B':
    console.log("You are doing well");
    break;
  case 'C':
    console.log("You are doing alright");
    break;
  case 'D':
    console.log("You are not doing well");
    break;
  case 'F':
